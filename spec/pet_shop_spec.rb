...
# Tests provided for exercise (uncomment as each test is found passing)
# Remember - TEST - FAIL - CODE - PASS - REFACTOR


require 'minitest/autorun' #require minitest library
require 'minitest/rg' #require minitest color output
require_relative '../pet_shop' #require input file to be tested

class TestPetShop < Minitest::Test #create new class, child of Test

  def setup # initialization method, prepares data structure for test methods to access


#Customers is an array of hashes.
#Symbols take up only one address in memory.
...
#New pet object will require new pet, hash {key:value pair,...}
    @new_pet = {
...
#Pet shop is a multidimensional hash containing array containing individual hashes
# for each pet - note that pets details are symbols. The @ symbol defines
#instance variables. Variables who are available only to methods of that class.
  ...
  def test_pet_shop_name #object of class pet_shop, confirm name is...
    name = pet_shop_name(@pet_shop) #pass the array pet shop
